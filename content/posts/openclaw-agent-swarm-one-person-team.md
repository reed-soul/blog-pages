...
![before Jan: CC/codex only | after Jan: Openclaw orchestrates CC/codex](/images/agent-swarm/commits-history.jpg)
...
![System Architecture](/images/agent-swarm/system-architecture.jpg)
...
![OpenClaw vs Codex Context](/images/agent-swarm/context-comparison.jpg)
